...
/**
 * Parser factory which generates a {@link MyStandaloneApplicationClusterConfiguration} from a given
 * list of command line arguments.
 */
public class MyStandaloneApplicationClusterConfigurationParserFactory implements ParserResultFactory<MyStandaloneApplicationClusterConfiguration> {
    ...
    @Override
    public MyStandaloneApplicationClusterConfiguration createResult(@Nonnull CommandLine commandLine) throws FlinkParseException {
        ...
        return new MyStandaloneApplicationClusterConfiguration(
                configDir,
                dynamicProperties,
                commandLine.getArgs(),
                hostname,
