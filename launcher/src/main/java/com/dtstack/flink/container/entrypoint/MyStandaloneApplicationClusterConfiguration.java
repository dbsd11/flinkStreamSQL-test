...
/**
 * Configuration for the {@link MyStandaloneApplicationClusterEntryPoint}.
 */
final class MyStandaloneApplicationClusterConfiguration extends EntrypointClusterConfiguration {
    ...
    MyStandaloneApplicationClusterConfiguration(
